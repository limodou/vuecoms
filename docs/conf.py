...
#mermaid init
mermaid_init = {'startOnLoad':False}
...
copyright = u'2017, Limodou'
description = u'''vuecoms is Vue component lib.
'''
download_url = 'https://github.com/limodou/vuecoms/archive/master.zip'
...
search = True
domain = 'limodou.github.io/vuecoms'
search_html = """
<div class="item">
